...
| 8000-9999 (119 DWG-served postcodes) | Kortrijk, Harelbeke, Roeselare, Waregem, Ieper, Sint-Niklaas outer parishes, Eeklo, Maldegem, etc. | De Watergroep |
| 8000-9999 (rest) | West-Vl. + Oost-Vl. (mostly Farys) | Farys |

9 postcodes in 8000-9999 are genuinely split between DWG and Farys at
street level (e.g. 8400 Oostende, 8490 Jabbeke, 9080 Lochristi, 9550
Herzele, 9570/9571 Lierde). The resolver keeps Farys as the dominant
default for these; users in the DWG half can switch operator via the
reconfigure flow's manual picker.
